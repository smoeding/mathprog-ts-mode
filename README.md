...
This is a major mode for [GNU Emacs](https://www.gnu.org/software/emacs/) 29.1 or later which adds support for the MathProg modeling language used by the [GNU Linear Programming Kit](https://www.gnu.org/software/glpk/), which is a subset of the [AMPL](https://en.wikipedia.org/wiki/AMPL) language.
